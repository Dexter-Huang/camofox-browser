...
#   3. Bumps version via npm version (which syncs OpenClaw and MCP package metadata)
...
# (which syncs OpenClaw and MCP package metadata), creates a git commit and tag
